...
enum Taxis {
    ...
    TAXI_A (new Taxi(Addresses.NOVOLISENSKA.getAddress(), "1B35623", false)),
    TAXI_B (new Taxi(Addresses.CERNOPOLNI.getAddress(), "1B35623", false)),
    TAXI_C (new Taxi(Addresses.KURIM.getAddress(), "1B35623", false)),
    TAXI_D (new Taxi(Addresses.K_BABE.getAddress(), "1B35623", true));
